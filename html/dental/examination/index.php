...
<fieldset><legend>On Examination</legend>	
	<form action="" method="POST"  name="" id="" class='tab_form patient_form2'>
		...
		<div class='grid-100 grid-parent   '>
			...
			<div class='grid-100 grid-parent highlight_on_hover1'><!--begin xrays-->
				...
				<div class='grid-20'><label for="" class="label">Comments</label></div>
				<div class=clear></div>
				<!-- <div class='grid-100'> -->
				...
				<?php 
					...
					foreach($s as $row){
						...
						<div class=grid-45><textarea  rows=1 class='xray_examination_input' name='<?php echo "xray_comment$count"; ?>' ></textarea></div>
						<div class=clear></div>
