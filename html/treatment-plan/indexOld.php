			...
			while($i <= 5){ 
				...
				echo "<div class='grid-100 tplan_procedures highlight_on_hover1 '>";//was hover before
					...
					echo "<div class='grid-45 grid-parent'>";
						...
						$sql2="select name,id,all_teeth,code from procedures where id!=2 and id!=8 and id!=59 and listed=0 order by name";
...
<!-- AJAX response must be wrapped in the modal's root class. -->
	<div class="grid-container" id="tst">
			
			<div class="grid-container"  id="treeview2"></div>	
