...
fill_treeview2();
 //var loaderx1 = fill_treeview2();

$('input[name^=codexxxxxxx]').click(function(event) {
	event.preventDefault();
	//this.blur(); // Manually remove focus from clicked link.
	var dat = 'testing';
	window.codex_id= $(this).attr('id');

	//update_selected_procedure_id(codex_id);
	
	var width_x = $('input[name^=codex]').parent().width();
	var height_y = 580;//$("#employer_form_div").height();
	//var loaderx1s = fill_treeview2();
	$('#tst').dialog({
		title: 'SELECT TREATMENT PROCEDURES',
		height: height_y,
		width: width_x,
		modal: true}).load(this.loaderx1s); 
	//alert('data is--------MMMMMMMMMMM :id-='+ codex_id);
	//$('#'+ codex_id).val(dat);
	...
	//$('input[name^=codex]').click(function(event) {
		...
		var height_y = 580;//$("#employer_form_div").height();
		var loaderx1 = fill_treeview2();
		//var all_pr = all_procedure_id(result_value ,result_text);
...
$('.procedure_containerxxxx').on('click', 'input[name^=codexcccc]', function(){
//$('input[name^=codex]').click(function(event) {
	event.preventDefault();
	//this.blur(); // Manually remove focus from clicked link.
	var dat = 'testing';
...
$('#manual-ajax1').click(function(event) {
	event.preventDefault();
	this.blur(); // Manually remove focus from clicked link.
	
	var width_x = $('input[name^=codex]').parent().width();
	var height_y = 580;//$("#employer_form_div").height();
	//var loader = fill_treeview2();
	$('#tst').dialog({
