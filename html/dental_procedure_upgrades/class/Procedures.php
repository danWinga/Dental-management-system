...
class Procedures {	
	...
	public function setAll_teeth($all_teeth){
		
		if (strpos($all_teeth, 'yes') !== false) {
			$this->all_teeth = $all_teeth;
		}
		elseif(strpos($all_teeth, 'yes') !== false) {
			$this->all_teeth = $all_teeth;
		}else{
			$this->all_teeth = 'no';
		}
	...
	public function updateRecord(){
		...
		if($this->getId()) {			
			...
			WHERE id = ?");
	 		/** 
			$this->id = htmlspecialchars(strip_tags($this->getId()));
			$this->name = htmlspecialchars(strip_tags($this->getName()));
			$this->all_teeth = htmlspecialchars(strip_tags($this->getAll_teeth()));
			$this->cost = htmlspecialchars(strip_tags($this->getCost()));
			$this->type = htmlspecialchars(strip_tags($this->getType()));
			$this->listed = htmlspecialchars(strip_tags($this->getListed()));
			$this->code = htmlspecialchars(strip_tags($this->getCode()));
			$this->parent_category_id = htmlspecialchars(strip_tags($this->getParent_category_id()));
			*/
			$this->setId( htmlspecialchars(strip_tags($this->id)));
			$this->setName(htmlspecialchars(strip_tags($this->name)));
			$this->setAll_teeth(htmlspecialchars(strip_tags($this->all_teeth)));
			$this->setCost(htmlspecialchars(strip_tags($this->cost)));
			$this->setType(htmlspecialchars(strip_tags($this->type)));
			$this->setListed(htmlspecialchars(strip_tags($this->listed)));
			$this->setCode(htmlspecialchars(strip_tags($this->code)));
			$this->setParent_category_id(htmlspecialchars(strip_tags($this->parent_category_id)));
	...
	public function addRecord(){
		...
		if($this->name) {
			...
			$stmt->bind_param("ssssssi", $this->name, $this->all_teeth, $this->cost, $this->type, $this->listed, $this->code, $this->parent_category_id);
