...
$(document).ready(function(){
	...
	//$('#search').click(function(){
		...
		var res_query = "";
		//var res_query = $('#result_query').val();
		//var loadedQry = lo
		...
		else if(start_date != '' && end_date !='' && res_query!='')
		{
...
function fill_treeview()
	...
	function fetch_both(is_date_search, start_date='', end_date='' , query ='')
	{
		$.ajax({
		url:"dental_procedure_upgrades/dist/summaryProcTable.php",
		method:"POST",
		data:{
			is_date_search:is_date_search, start_date:start_date, end_date:end_date, query=''				},
		success:function(data)
		{
			$('#result').html(data);
		}
