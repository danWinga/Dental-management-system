...
echo "<div class='grid_12 page_heading'>TREATMENT PROCEDURES</div>";
...
?>
<?php 
	include_once('dental_procedure_upgrades/inc/header.php');
					...
					<div class="col-md-12">
						...
						<!-- Start-->
							<div class="col-md-12">
								...
								<div class="form-group">
									<div class="col-md-3">  
										<input type="text" name="from_date" id="from_date" class="date_picker" autocomplete="off" placeholder="From Date" />  
									</div>  
									<div class="col-md-3">  
										<input type="text" name="to_date" id="to_date" class="date_picker"  autocomplete="off" placeholder="To Date" />  
									</div>  
									<div class="col-md-5">  
								...
								<div class="row">
									...
									<div class="input-daterange">
										<div class="col-md-4">
											<input type="text" name="start_date" id="start_date" autocomplete="off" class="date_picker" placeholder="From Date" />
										</div>
										<div class="col-md-4">
											<input type="text" name="end_date" id="end_date" autocomplete="off" class="date_picker" placeholder="To Date"  />
										</div>      
									</div>
									<div class="col-md-4">
										<input type="button" name="searchA" id="searchA" value="Search" class="btn btn-info" />
									</div>
								</div>															
