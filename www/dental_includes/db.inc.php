...
try
{
  $pdo_old = new PDO('mysql:host=localhost;dbname=dental', 'root', 'CoA!b_U');  //when changin this remember to change also the file connect_to_session_db.php as it also has credentials
...
try
{
  $pdo = new PDO('mysql:host=127.0.0.1;dbname=dental', 'root', 'Admin@winga123');  //when changin this remember to change also the file connect_to_session_db.php as it also has credentials
...
{
	echo 'Connection to database failed:x ' ;
  exit();
